                ...
                <ul className="m-0">
                    <li className="d-flex">
                        ...
                        <strong className="ms-auto">
                            {data.sbpRiskGb === 'H' && <RedSpan>{data.sbpResult}</RedSpan>}
                            {data.sbpRiskGb === 'L' && <BlueSpan>{data.sbpResult}</BlueSpan>}
                            {data.sbpRiskGb === '' && <BlackSpan>{data.sbpResult}</BlackSpan>}
                            <BlackSpan>/</BlackSpan>
                            {data.dbpRiskGb === 'H' && <RedSpan>{data.dbpResult}</RedSpan>}
                            {data.dbpRiskGb === 'L' && <BlueSpan>{data.dbpResult}</BlueSpan>}
                            {data.dbpRiskGb === '' && <BlackSpan>{data.dbpResult}</BlackSpan>}
                        </strong>
                    </li>
                    <li className="d-flex">
                        <span>심박수</span>
